...
namespace RootMotion.Demos
{
    ...
    public class CreateRagdollInRuntime : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            BipedReferences bipRef = null;

            BipedReferences.AutoDetectReferences( ref bipRef, instance.transform, BipedReferences.AutoDetectParams.Default );

            // Find bones (Humanoids)
            BipedRagdollReferences r = BipedRagdollReferences.FromBipedReferences( bipRef );
